...
global.helpme.post('/saveUtilizador', function (req, res) {
    ...
    global.modelRegisto.save(req.body.nome, req.body.idade, req.body.genero, req.body.profissao, req.body.email, req.body.password, req.body.descricao, req.body.ramo_emp,
