            ...
            if (request.status == 200) {
                ...
                if (lin == "PT") {
                    ...
                    if (data[0].profissao == "Estudante") {
                        var aluno = "";
                        aluno += '<div class="col-lg-3">';
                        aluno += '<div class="form-group"><label class="custom-label">Name:</label><input type="text" class="form-control form-control-user" id="nome" value="' + data[0].nome + '"></div>';
                        aluno += '<div class="form-group" id="idadeDiv"><label class="custom-label">Age:</label><input type="number" class="form-control form-control-user" id="idade" value="' + data[0].idade + '"></div>';
                        aluno += '<div class="form-group" id="generoDiv"><label class="custom-label">Gender:</label><select class="form-control form-control-user" data-live-search="true" id="genero">';
                        aluno += '<option value="' + data[0].genero + '">' + data[0].genero + '</option><option value="Masculino">Masculino</option><option value="Feminino">Feminino</option></select></div>';
                        aluno += '</div>';
                        aluno += '<div class="col-lg-3">';
                        aluno += '<div class="form-group"><label class="custom-label">E-mail:</label><input type = "email" class="form-control form-control-user" id = "email" aria - describedby="" value = "' + data[0].email + '"></div>';
                        ...
                        aluno += '</div>';
                        aluno += '<div class="col-lg-3">';
                        aluno += '<div class="form-group"><label class="custom-label">Description:</label><textarea class="form-control form-control-user" id = "descricao" rows = "5" cols = "30" value ="">' + data[0].descricao + '</textarea ></div>';
                        aluno += '<div class="form-group"><label class="custom-label">Profession:</label><input type = "text" class="form-control form-control-user" id="profissao" value="' + data[0].profissao + '" disabled></div>';
                        //aluno += '<div class="form-group"><label class="custom-label">Profissão:</label><select class="form-control form-control-user" data-live-search="true" id="profissao" onchange="checkProfissao(this);">';
                        //aluno += '<option value="" disabled selected>' + data[0].profissao + '</option><option value="Empresa">Empresa</option>option value="Gestor de Projetos">Gestor de Projetos</option><option value="Professor/Investigador">Professor/Investigador</option><option value="Estudante">Estudante</option></select></div>';
                        aluno += '<div class="form-group" id="Estudante"><label class="custom-label">Study Cycle:</label><input type="text" class="form-control form-control-user" id="estudo" aria-describedby="" value="' + data[0].ciclo_estudo + '"></div>';
                        aluno += '</div>';
                        $("#aluno_section").html(aluno);
                    } else if (data[0].profissao == "Professor/Investigador") {
                        var pi = "";
                        pi += '<div class="col-lg-3">';
                        pi += '<div class="form-group"><label class="custom-label">Name:</label><input type="text" class="form-control form-control-user" id="nome" aria-describedby="" value="' + data[0].nome + '"></div>';
                        pi += '<div class="form-group" id="idadeDiv"><label class="custom-label">Age:</label><input type="number" class="form-control form-control-user" id="idade" aria-describedby="" value="' + data[0].idade + '"></div>';
                        pi += '<div class="form-group" id="generoDiv"><label class="custom-label">Gender:</label><select class="form-control form-control-user" data-live-search="true" id="genero">';
                        pi += '<option value="' + data[0].genero + '">' + data[0].genero + '</option><option value="Masculino">Masculino</option><option value="Feminino">Feminino</option></select></div>';
                        pi += '</div>';
                        pi += '<div class="col-lg-3">';
                        pi += '<div class="form-group"><label class="custom-label">E-mail:</label><input type = "email" class="form-control form-control-user" id = "email" aria - describedby="" value = "' + data[0].email + '"></div>';
                        ...
                        pi += '</div>';
                        pi += '<div class="col-lg-3">';
                        pi += '<div class="form-group"><label class="custom-label">Description:</label><textarea class="form-control form-control-user" id = "descricao" name = "message" rows = "5" cols = "30" value = "">' + data[0].descricao + '</textarea></div>';
                        pi += '<div class="form-group"><label class="custom-label">Profession:</label><input type = "text" class="form-control form-control-user" id="profissao" value="' + data[0].profissao + '" disabled></div>';
                        //pi += '<div class="form-group"><label class="custom-label">Profissão:</label><select class="form-control form-control-user" data-live-search="true" id="profissao" onchange="checkProfissao(this);">';
                        //pi += '<option value="" disabled selected>' + data[0].profissao + '</option><option value="Empresa">Empresa</option>option value="Gestor de Projetos">Gestor de Projetos</option><option value="Professor/Investigador">Professor/Investigador</option><option value="Estudante">Estudante</option></select></div>';
                        pi += '<div class="form-group" id="PI"><label class="custom-label">Scientific Area:</label><input type="text" class="form-control form-control-user" id="area" aria-describedby="" value="' + data[0].area_cientifica + '"></div>';
                        pi += '</div>';
                        $("#pi_section").html(pi);
                    } else if (data[0].profissao == "Gestor de Projeto") {
                        var gp = "";
                        gp += '<div class="col-lg-3">';
                        gp += '<div class="form-group"><label class="custom-label">Name:</label><input type="text" class="form-control form-control-user" id="nome" aria-describedby="" value="' + data[0].nome + '"></div>';
                        gp += '<div class="form-group" id="idadeDiv"><label class="custom-label">Age:</label><input type="number" class="form-control form-control-user" id="idade" aria-describedby="" value="' + data[0].idade + '"></div>';
                        gp += '<div class="form-group" id="generoDiv"><label class="custom-label">Gender:</label><select class="form-control form-control-user" data-live-search="true" id="genero">';
                        gp += '<option value="' + data[0].genero + '">' + data[0].genero + '</option><option value="Masculino">Masculino</option><option value="Feminino">Feminino</option></select></div>';
                        gp += '</div>';
                        gp += '<div class="col-lg-3">';
                        gp += '<div class="form-group"><label class="custom-label">E-mail:</label><input type = "email" class="form-control form-control-user" id = "email" aria - describedby="" value = "' + data[0].email + '" ></div>';
                        gp += '<div class="form-group"><label class="custom-label">Password:</label><input type = "password" class="form-control form-control-user" id = "password" aria - describedby="" value = "' + data[0].password + '"></div>';
                        gp += '<div class="form-group"><label class="custom-label">Description:</label><textarea class="form-control form-control-user" id = "descricao" name = "message" rows = "5" cols = "30" value = "">' + data[0].descricao + '</textarea ></div>';
                        gp += '</div>';
                        gp += '<div class="col-lg-3">';
                        gp += '<div class="form-group"><label class="custom-label">Profession:</label><input type = "text" class="form-control form-control-user" id="profissao" value="' + data[0].profissao + '" disabled></div>';
                        //gp += '<div class="form-group"><label class="custom-label">Profissão:</label><select class="form-control form-control-user" data-live-search="true" id="profissao" onchange="checkProfissao(this);">';
                        //gp += '<option value="" disabled selected>' + data[0].profissao + '</option><option value="Empresa">Empresa</option>option value="Gestor de Projetos">Gestor de Projetos</option><option value="Professor/Investigador">Professor/Investigador</option><option value="Estudante">Estudante</option></select></div>';
                        gp += '<div class="form-group"><label class="custom-label">Company Name:</label><input type="text" class="form-control form-control-user" id="gp_nome_emp" aria-describedby="" value="' + data[0].gp_nome_emp + '"></div>';
                        gp += '<div class="form-group"><label class="custom-label">Business Branch:</label><input type="text" class="form-control form-control-user" id="ramoEp" aria-describedby="" value="' + data[0].ramo_emp + '"></div>';
                        gp += '<div class="form-group"><label class="custom-label">Number of Employees:</label><input type="text" class="form-control form-control-user" id="nEmpregados" aria-describedby="" value="' + data[0].num_trabalhadores + '"></div>';
                        gp += '<div class="form-group"><label class="custom-label">Country Region:</label><select class="form-control form-control-user" data-live-search="true" id="regiao">';
                        gp += '<option value="' + data[0].regiao_pais + '">' + data[0].regiao_pais + '</option><option value="Alentejo">Alentejo</option><option value="Algarve">Algarve</option><option value="Beira Interior">Beira Interior</option>';
                        gp += '<option value="Beira Litoral">Beira Litoral</option><option value="Entre Douro e Minho">Entre Douro e Minho</option><option value="Ribatejo e Oeste">Ribatejo e Oeste</option><option value="Região Autónoma dos Açores">Região Autónoma dos Açores</option><option value="Região Autónoma da Madeira">Região Autónoma da Madeira</option></select></div>';
                        gp += '</div>';
                        $("#gp_section").html(gp);
                        ...
                        var empresa = "";
                        empresa += '<div class="col-lg-3">';
                        empresa += '<div class="form-group"><label class="custom-label">Name:</label><input type="text" class="form-control form-control-user" id="nome" aria-describedby="" value="' + data[0].nome + '"></div>';
                        empresa += '</div>';
                        empresa += '<div class="col-lg-3">';
                        empresa += '<div class="form-group"><label class="custom-label">E-mail:</label><input type = "email" class="form-control form-control-user" id = "email" aria - describedby="" value = "' + data[0].email + '"></div>';
                        empresa += '<div class="form-group"><label class="custom-label">Password:</label><input type = "password" class="form-control form-control-user" id = "password" aria - describedby="" value = "' + data[0].password + '"></div>';
                        empresa += '<div class="form-group"><label class="custom-label">Description:</label><textarea class="form-control form-control-user" id = "descricao" name = "message" rows = "5" cols = "30" value = "">' + data[0].descricao + '</textarea ></div>';
                        empresa += '</div>';
                        empresa += '<div class="col-lg-3">';
                        empresa += '<div class="form-group"><label class="custom-label">Profession:</label><input type = "text" class="form-control form-control-user" id="profissao" value="' + data[0].profissao + '" disabled></div>';
                        //empresa += '<div class="form-group"><label class="custom-label">Profissão:</label><select class="form-control form-control-user" data-live-search="true" id="profissao" onchange="checkProfissao(this);">';
                        //empresa += '<option value="" disabled selected>' + data[0].profissao + '</option><option value="Empresa">Empresa</option>option value="Gestor de Projetos">Gestor de Projetos</option><option value="Professor/Investigador">Professor/Investigador</option><option value="Estudante">Estudante</option></select></div>';
                        empresa += '<div class="form-group"><label class="custom-label">Business Branch:</label><input type="text" class="form-control form-control-user" id="ramoEp" aria-describedby="" value="' + data[0].ramo_emp + '"></div>';
                        empresa += '<div class="form-group"><label class="custom-label">Number of Employees:</label><input type="text" class="form-control form-control-user" id="nEmpregados" value="' + data[0].num_trabalhadores + '"></div>';
                        empresa += '<div class="form-group"><label class="custom-label">Country Region:</label><select class="form-control form-control-user" data-live-search="true" id="regiao">';
                        empresa += '<option value="' + data[0].regiao_pais + '">' + data[0].regiao_pais + '</option><option value="Alentejo">Alentejo</option><option value="Algarve">Algarve</option><option value="Beira Interior">Beira Interior</option>';
                        empresa += '<option value="Beira Litoral">Beira Litoral</option><option value="Entre Douro e Minho">Entre Douro e Minho</option><option value="Ribatejo e Oeste">Ribatejo e Oeste</option><option value="Região Autónoma dos Açores">Região Autónoma dos Açores</option><option value="Região Autónoma da Madeira">Região Autónoma da Madeira</option></select></div>';
                        empresa += '</div>';
                        $("#empresa_section").html(empresa);
